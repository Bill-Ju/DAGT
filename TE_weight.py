...
# data
parser.add_argument('--suffix', type=str, default='Spring_Weight_ER50_exp0', help='suffix for data')

parser.add_argument('--tr_num', type=int, default=15,
...
tot_pearson_, tot_pearson_topk, weight_gap = cal_accuracy_for_weight(A, W, int(num_edges*0.1))
...
tot_pearson, tot_pearson_topk, weight_gap = cal_accuracy_for_weight(A, W, int(num_edges*0.1))
# print('MI:',f'{tot_pearson*100:.2f}')

# auc_te_200, acc, pre = cal_accuracy(A, W, W>1, num_edges, 0)

auc_te=np.maximum(tot_pearson_,tot_pearson)

print('TE:',f'{tot_pearson*100:.2f}')