...
if __name__ == '__main__':
    ...
    for exp_id in range(args.exp_num):
        ...
        min_w = 0.01 
        # Maximum weight (less than or equal to 1)
        max_w = 1.0   
        for u, v in G.edges():
            # Use np.random.uniform to generate uniform random numbers in the range [min_w, max_w)
        ...
        data_path = 'FJ_Weight_' + args.graph + str(args.num_nodes) + '_exp' + str(exp_id) +'.pickle'
